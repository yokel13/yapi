...
class Http {
     ...
     * @param $code
     */
    public static function setStatusCode($code = self::HTTP_OK) {
        http_response_code($code);
    }

    /**
     * Устанавливает http-статус 404
     */
    ...
    /**
     * Устанавливает http-статус 403
     */
    public static function forbidden() {
        self::setStatusCode(self::HTTP_FORBIDDEN);
    }

    /**
     * Устанавливает http-статус 400
     */
